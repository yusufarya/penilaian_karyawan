...
<div class="container-fluid" style="height: 100vh;">
    ...
    <div class="row mt-2 p-3">
            ...
            <tbody>
                ...
                ?>
                    <tr style="font-size: 13px;">
                        ...
                        <td><input type="text" disabled name="nilai1[]" id="nilai1" style="width: 50px;" placeholder="" value="<?= $nilai1 ?>"></td>
                        <td><input type="text" disabled name="ketentuan_nilai1[]" id="ketentuan_nilai1" style="width: 180px;" value="<?= $ketentuan_nilai1 ?>"></td>
                        <td><input type="text" disabled name="sikap_kerja[]" id="sikap_kerja" style="width: 140px;" value="<?= $sikap_kerja ?>"></td>
                        <td><input type="text" disabled name="nilai2[]" id="nilai2" style="width: 50px;" placeholder="0" value="<?= $nilai2 ?>"></td>
                        <td><input type="text" disabled name="ketentuan_nilai2[]" id="ketentuan_nilai2" style="width: 180px;" value="<?= $ketentuan_nilai2 ?>"></td>
                    </tr>
                <?php }
                ?>
            </tbody>
        ...
        <hr>
        <div>
            <a href="<?= base_url('penilaian_saya') ?>" class="text-decoration-none"> <i class="bi bi-backspace-fill"></i> Kembali</a>
        </div>
    </div>
