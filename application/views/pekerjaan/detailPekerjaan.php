...
<div class="container-fluid" style="height: 100vh;">
  ...
  <!-- Page Heading -->
  <form action="<?php echo base_url('detailPekerjaan') ?>" method="post">
    <div class="row">
  ...
  <div class="row mt-2 mx-0">
    ...
    <table class="table table-sm table-hover table-bordered">
      ...
      <tbody>
        ...
        $no = 1;
        $tempKaryawan = '';
        foreach ($data['listPekerjaan'] as $key => $val) {
          $karyawan = $val['nama'];
        ...
        ?>
            <tr style="font-size: 13px;">
              ...
              <td style="text-align: center;">
                <a href="#" class="btn btn-info py-0 px-2" onclick="modalDtail('<?= $val['id'] ?>', <?= $level_ ?>)" class="text-info bg-white"><i class="bi bi-info"></i></a> &nbsp;
              </td>
            </tr>
        <?php }
